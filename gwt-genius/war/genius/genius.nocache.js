...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "genius" because\n';
  ...
  $wnd.__gwt_activeModules['genius'] = {
    'moduleName' : 'genius',
    'bindings' : function() {
      return {};
    }
 ...
 * "/genius.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['genius'].superdevmode = true;

  var expectedSuffix = '/genius.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + genius + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:genius';
  var devModeSessionKey = '__gwtDevModeSession:genius';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/genius/genius.nocache.js';
  ...
  $wnd.__gwt_activeModules['genius'].canRedirect = true;
  $wnd.__gwt_activeModules['genius'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/genius?user.agent=' + ua + '&_callback=' + callback;
